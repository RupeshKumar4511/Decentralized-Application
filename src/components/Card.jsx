const Card = ({ allcampaign, setOpenModel, setDonate, title }) => {
    ...
    return (
        <div className="px-4 py-16 mx-auto sm:max-w-sm sm:mx-auto lg:max-w-screen-xl
            ...
            <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
                {allcampaign?.map((campaign, i) => (
                    <div
                        ...
                        key={i + 1}
                        className="cursor-pointer border overflow-hidden transiton-shadow 
    duration-300 bg-white rounded">
                        ...
                        <div className="py-5 pl-2">
                            <p className="mb-2 text-xs font font-semibold text-gray-600 uppercase">
                            ...
                            <p className="mb-4 text-gray-700">{campaign.description}
                            </p>
